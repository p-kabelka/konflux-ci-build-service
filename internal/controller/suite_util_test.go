...
const (
	...
	gitPipelineName               = "docker-build-oci-ta"
	gitPipelineURL                = "https://github.com/konflux-ci/build-definitions.git"
	gitPipelineRevision           = "main"
	gitPipelinePath               = "pipelines/docker-build-oci-ta/docker-build-oci-ta.yaml"
	nonConfigMapGitPipelineName   = "tekton-bundle-builder-oci-ta"
	nonConfigMapGitPipelinePath   = "pipelines/tekton-bundle-builder-oci-ta/tekton-bundle-builder-oci-ta.yaml"
	bundlePipelineGitPathOverride = "pipelines/docker-build/docker-build.yaml"
